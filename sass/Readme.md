...
folder are mapped to the application's root namespace, 'SamsungSencha'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SamsungSencha"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SamsungSencha' in the same way
as `"SamsungSencha/sass/src"`.
